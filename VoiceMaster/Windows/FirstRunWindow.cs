...
{
    public FirstTimeWindow() : base($"First time using VoiceMaster###EKFirstTime")
    {
    ...
    public override void Draw()
    {
        try
        {
            ...
            {
                ImGui.Text(
                    "Hey!\r\nIt seems like this is your first time using VoiceMaster. Please read this carefully.");
